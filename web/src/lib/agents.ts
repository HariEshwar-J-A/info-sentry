...
export const AGENT_DEFS: Record<string, {
  ...
  analyst: {
    label: 'Analyst / Pipeline',
    description: 'Analyzes scraped articles — generates summaries, embeddings, predictions and posts to Telegram',
    icon: '🧠',
  ...
  'prediction-verifier': {
    ...
    description: 'Checks tracked predictions against recent news + DuckDuckGo using kimi-k2.6 chain-of-thought',
    icon: '🔮',
  ...
  prediction: {
    ...
    description: 'Generates predictions for individual article summaries (called by analyst pipeline)',
    icon: '🎯',
    script: null,
    defaultModel: 'moonshotai/kimi-k2.6',
  },
  feedback: {
    label: 'Feedback',
    description: 'Processes user feedback signals and updates interest scores (event-driven)',
    icon: '💬',
    script: null,
  ...
  manager: {
    label: 'Manager',
    description: 'System health, budget monitoring and Telegram DM commands',
    icon: '📊',
