  ...
  return (
    <form onSubmit={(e) => void handleSubmit(e)} style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
      ...
      <div style={{ display: 'flex', gap: '14px', alignItems: 'center', flexWrap: 'wrap' }}>
        ...
        <Button type="submit" variant="primary" size="sm" disabled={loading || !topic.trim()} loading={loading} style={{ marginLeft: 'auto' }}>
      ...
      <TopBar
        ...
        actions={
          <SegmentTabs
            variant="pills"
            active={tab}
            onChange={id => id && setTab(id as typeof tab)}
            items={[
        ...
        {tab === 'clusters' && (
          <>
            {loadingClusters ? (
              ...
              <EmptyState title="No topic clusters yet" description="Articles need to be analysed first" />
            ) : (
              <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
