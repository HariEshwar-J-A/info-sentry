...
import { ArrowLeft, ExternalLink, Clock, Calendar, Video, ChevronDown, ChevronUp } from 'lucide-react'
    ...
    <div style={{ minHeight: '100vh', backgroundColor: '#0a0a0a' }}>
      ...
      <div style={{ maxWidth: '820px', margin: '0 auto', padding: '32px 24px' }}>
        ...
        <div style={{ marginBottom: '24px' }}>
          ...
          {!video.transcript ? (
            <div style={{ backgroundColor: '#111', border: '1px dashed #2a2a2a', borderRadius: '12px', padding: '20px 24px', textAlign: 'center', color: '#555', fontSize: '13px' }}>
              Transcript not available. YouTube auto-captions may not be enabled for this video,
              or the channel uses manual captions that aren't publicly accessible.
            </div>
          ) : showTranscript ? (
